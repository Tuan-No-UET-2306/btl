...
VIDEO_TRACK_IOU_THRESHOLD = min(1.0, max(0.05, float(os.getenv("VIDEO_TRACK_IOU_THRESHOLD", "0.25"))))
VIDEO_STABLE_MIN_VOTES = max(1, int(os.getenv("VIDEO_STABLE_MIN_VOTES", "2")))
VIDEO_STABLE_MIN_OCR_CONFIDENCE = min(
    1.0,
    max(0.0, float(os.getenv("VIDEO_STABLE_MIN_OCR_CONFIDENCE", "0.45"))),
)
VIDEO_FLUSH_MIN_OCR_CONFIDENCE = min(
    1.0,
    max(0.0, float(os.getenv("VIDEO_FLUSH_MIN_OCR_CONFIDENCE", "0.65"))),
)
